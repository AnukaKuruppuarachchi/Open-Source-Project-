...
enum class test_plain_sprited_bodies {
	...
	DETACHED_METROPOLIS_ARM_TOP,
	DETACHED_METROPOLIS_ARM_BOTTOM,
	DETACHED_RESISTANCE_ARM_TOP,
	DETACHED_RESISTANCE_ARM_BOTTOM,

	LYING_CORPSE_METROPOLIS,
	LYING_CORPSE_METROPOLIS_NOARM,
	LYING_CORPSE_METROPOLIS_NOARMS,
	LYING_CORPSE_RESISTANCE,
	LYING_CORPSE_RESISTANCE_NOARM,
	LYING_CORPSE_RESISTANCE_NOARMS,
