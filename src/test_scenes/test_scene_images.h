...
enum class test_scene_image_id {
	...
	METROPOLIS_TORSO_TATTERED,
	RESISTANCE_TORSO_TATTERED,

	METROPOLIS_TORSO_TATTERED_NOARM,
	RESISTANCE_TORSO_TATTERED_NOARM,

	METROPOLIS_TORSO_TATTERED_NOARMS,
	RESISTANCE_TORSO_TATTERED_NOARMS,

	METROPOLIS_GORE_ARM_TOP,
	METROPOLIS_GORE_ARM_BOTTOM,
	RESISTANCE_GORE_ARM_TOP,
	RESISTANCE_GORE_ARM_BOTTOM,

	METROPOLIS_TORSO_CORPSE,
	RESISTANCE_TORSO_CORPSE,

	METROPOLIS_TORSO_CORPSE_NOARM,
	RESISTANCE_TORSO_CORPSE_NOARM,

	METROPOLIS_TORSO_CORPSE_NOARMS,
	RESISTANCE_TORSO_CORPSE_NOARMS,

	METROPOLIS_TORSO_CORPSE_HEAD,
	RESISTANCE_TORSO_CORPSE_HEAD,
